  ...
  head: () => ({
    meta: [
      ...
      { title: APP_NAME },
      {
        name: "description",
        content:
          "Private invitation to the wedding of Bontu and Abdisa — 28 February 2027 at The Shore Chapel, Katathani, Phuket.",
      },
      { name: "theme-color", content: "#1A4554" },
    ],
    links: [
